  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: context.colors.primary,
        title: Text(user?.name ?? '', style: context.textStyles.textPrimaryFontRegular.copyWith(color: Colors.white)),
        actions: [
          IconButton(
                  ...
                  child: Column(
                    children: [
                      ...
                      Button(
                        ...
                        labelStyle: context.textStyles.textSecondaryFontExtraBold.copyWith(color: context.colors.yellow),
