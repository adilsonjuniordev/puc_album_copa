                ...
                delegate: SliverChildListDelegate.fixed([
                  ...
                  Padding(
                    ...
                    child: InkWell(
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              title: Text('Ops..', style: context.textStyles.textSecondaryFontExtraBold),
                              content: const Text('Recurso ainda não disponível.\nEm breve será implementado.'),
                              contentTextStyle: context.textStyles.textSecondaryFontRegular.copyWith(color: Colors.black, fontSize: 16),
                              actions: [
                                Center(
                      ...
                      child: Text(
                        'Esqueceu a senha?',
                        style: context.textStyles.textSecondaryFontMedium.copyWith(color: context.colors.yellow, fontSize: 14),
                      ),
                    ),
                  ),
                  const SizedBox(
